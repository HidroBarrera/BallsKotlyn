...
// every frame of the animation.
    ...
    override fun onTouchEvent(event: MotionEvent): Boolean {
        ...
        val squashAnim2: ValueAnimator =
            ObjectAnimator.ofFloat(newBall, "width", newBall.width, newBall.width + 50)
        ...
        val stretchAnim1: ValueAnimator = ObjectAnimator.ofFloat(newBall, "y", endY, endY + 25f)
        ...
        val stretchAnim2: ValueAnimator =
            ObjectAnimator.ofFloat(newBall, "height", newBall.height, newBall.height - 25)
        ...
        val bounceBackAnim: ValueAnimator = ObjectAnimator.ofFloat(newBall, "y", endY, startY + (endY-startY)/2)
